...
/* 
    terry has black  strands hair 
    Sheldon has blong curly hair 
...
// console.log(`${users[0].name} has ${users[0].hair.color} ${users[0].hair.type} hair and he lives in`);
// console.log(`${users[1].name} has ${users[1].hair.color} ${users[1].hair.type} hair and he lives in`);
// console.log(`${users[2].name} has ${users[2].hair.color} ${users[2].hair.type} hair and he lives in`);
// console.log(`${users[3].name} has ${users[3].hair.color} ${users[3].hair.type} hair and he lives in`);
// console.log(`${users[4].name} has ${users[4].hair.color} ${users[4].hair.type} hair and he lives in`);
// console.log(`${users[5].name} has ${users[5].hair.color} ${users[5].hair.type} hair and he lives in`);
...
function printUserInfo(userObject) {
    console.log(`${userObject.firstName} has ${userObject.hair.color} ${userObject.hair.type} hair and he lives in ${userObject.address.address}`);
    console.log("\n")
}

// Alison has Blond Straight hair
...
/* loop
        ...
        - do while
  */
// // for ( start-point ; condition-if-else; mutator-incrementor ) {
